...
class HomePage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton(
          ...
          child: const Text('Set badge no',style: TextStyle(color: Colors.white),),
  ...
  setBadgeNum(int count, BuildContext context) async {
    ...
    QuickAlert.show(
      ...
      confirmBtnColor: Color(0xff293462),
    );
  }
}
...
getBtnStyle(context) => ElevatedButton.styleFrom(
    ...
    fixedSize: Size(MediaQuery.of(context).size.width-100, 47),
